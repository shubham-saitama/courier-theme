<?php
  $content_type = get_theme_mod( 'vw_courier_serivce_pro_post_content_blog','Excerpt Content');
  $excerpt_length="";
  if($content_type == "Excerpt Content"){
    $excerpt_length=get_theme_mod( 'vw_courier_serivce_pro_excerpt_length',15);
  }
  $theme_lay = get_theme_mod( 'vw_courier_serivce_pro_plugin_single_blog_option','two_col');
                ...
                <div class="vw-news-meta">
                  ...
                  <div class="latest-news-text mb-2">
                    <?php
                          ...
                          echo esc_html(vw_courier_serivce_pro_string_limit_words($excerpt,('19')));
                      ?>
                  </div>
              </div>
        </div>
