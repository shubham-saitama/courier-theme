...
class wpb_widget extends WP_Widget {
	function __construct() {
		...
		// Base ID of your widget
			...
			__('Contact Us', 'vw-courier-serivce-pro'),
			// Widget description
			array( 'description' => __( 'Widget for About Us section', 'vw-courier-serivce-pro' ), )
		);
	}
...
// This is where the action happens
	...
	public function form( $instance ) {
		...
		if ( isset( $instance[ 'custom_title' ] ) ) {
			...
			esc_html($custom_title = __( 'New title', 'vw-courier-serivce-pro' ));
		}
		//custom_content
		if ( isset( $instance[ 'custom_content' ] ) ) {
			...
			esc_html($custom_content = __( 'Custom Content', 'vw-courier-serivce-pro' ));
		}
		//Location
		if ( isset( $instance[ 'location' ] ) ) {
			...
			esc_html($location = __( 'Location', 'vw-courier-serivce-pro' ));
		}
		//Phone
		if ( isset( $instance[ 'phone' ] ) ) {
			...
			esc_html($phone = __( 'Phone', 'vw-courier-serivce-pro' ));
		}
		//Email
		if ( isset( $instance[ 'email' ] ) ) {
			...
			esc_html($email = __( 'Email', 'vw-courier-serivce-pro' ));
		}
		...
		if ( isset( $instance[ 'time' ] ) ) {
			...
			esc_html($time = __( 'Time', 'vw-courier-serivce-pro' ));
		}

		?>
			<!--Main title field -->
			<p>
				<label for="<?php echo esc_attr($this->get_field_id( 'custom_title' )); ?>"><?php esc_html_e( 'Title:', 'vw-courier-serivce-pro' ); ?></label>
			...
			<!--Message field -->
			<p>
				<label for="<?php echo esc_attr($this->get_field_id( 'custom_content' )); ?>"><?php esc_html_e( 'Content:','vw-courier-serivce-pro' ); ?></label>
			...
			<!--Location field-->
			<p>
				<label for="<?php echo esc_attr($this->get_field_id( 'location' )); ?>"><?php esc_html_e( 'Location:', 'vw-courier-serivce-pro'); ?></label>
			...
			<!--Phone field-->
			<p>
				<label for="<?php echo esc_attr($this->get_field_id( 'phone' )); ?>"><?php esc_html_e( 'Phone:', 'vw-courier-serivce-pro'); ?></label>
				<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'phone' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'phone' )); ?>" type="text" value="<?php echo esc_attr( $phone ); ?>" />
			</p>
			<!--Email field -->
			<p>
				<label for="<?php echo esc_attr($this->get_field_id( 'email' )); ?>"><?php esc_html_e( 'Email:', 'vw-courier-serivce-pro'); ?></label>
				<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'email' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'email' )); ?>" type="text" value="<?php echo esc_attr( $email ); ?>" />
			</p>
			<!-- Time  -->
			<p>
				<label for="<?php echo esc_attr($this->get_field_id( 'time' )); ?>"><?php esc_html_e( 'Time:', 'vw-courier-serivce-pro'); ?></label>
