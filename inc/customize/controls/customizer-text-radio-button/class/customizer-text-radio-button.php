 ...
 */
 class vw_courier_serivce_pro_Text_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
 ...
 */
if ( ! function_exists( 'vw_courier_serivce_pro_text_sanitization' ) ) {
	function vw_courier_serivce_pro_text_sanitization( $input ) {
