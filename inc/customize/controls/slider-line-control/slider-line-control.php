<?php
	...
	class vw_courier_serivce_pro_Slider_Custom_Control extends WP_Customize_Control {
		/**
	...
	function vw_courier_serivce_pro_slider_line_script() {
	...
	add_action( 'customize_controls_enqueue_scripts', 'vw_courier_serivce_pro_slider_line_script' );
